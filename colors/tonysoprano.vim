...
let colors_name = "tonysoprano"

if !exists("g:tonysoprano_html_link_underline") " {{{
    let g:tonysoprano_html_link_underline = 1
endif " }}}

if !exists("g:tonysoprano_css_props_highlight") " {{{
    let g:tonysoprano_css_props_highlight = 0
endif " }}}
...
if exists('g:tonysoprano_darkgutter') && g:tonysoprano_darkgutter
...
if g:tonysoprano_css_props_highlight
...
if g:tonysoprano_html_link_underline
